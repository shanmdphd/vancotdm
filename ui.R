...
navbarPage("vancomycin TDM",theme = shinytheme("paper"),
           tabPanel("Patient Info",tabName="pinfo",icon = icon("user-plus"),
                    
                    h2("Patient Information",align='center',style="color:#dbdbdb; font-weight:bold"),
                    tags$hr(),
                    column(width=2),
                    column(width=4,
           ...
           tabPanel("Dosage regimen", tabName="dosa",icon = icon("eyedropper"),
                    ...
                    column(width=2),
                    column(width=4,
                           box(width = NULL, status = "primary", solidHeader = TRUE, title="Upload Dosing History", 
           ...
           tabPanel("Obesrvations", tabName="obs",icon = icon("flask"),
                    ...
                    column(width=4,
                           conditionalPanel(condition = "input.Observations == 1", 
                                            box(width = NULL , solidHeader = TRUE, title="First Observation" 
                                                ...
                                                numericInput("obsc", "Observed Concentration (mg/L)", 5, min = NA, max = NA, step = NA,
                                                             width = NULL)
                                                ,
                                                dateInput("obsDate", "Date", value = NULL, min = NULL, max = NULL,
                           ...
                           conditionalPanel(condition = "input.Observations == 2",
                                            
                                            
                                            box(width = NULL ,solidHeader = TRUE, title="First Observation" 
                                                ,
                                                numericInput("obsc1", "Observed Concentration (mg/L)", 4.5, min = NA, max = NA, step = NA,
                                                             width = NULL)
                                                ,
                                                textInput("obsd1", "Time", value = "2017-01-01", width = NULL, placeholder = NULL)
                                                ,
                                                timeInput("obst1", "Date", value = strptime("23:30", "%R"), seconds = FALSE)
                                            ...
                                            box(width = NULL ,solidHeader = TRUE, title="Second Observation"
                                                ,
                                                numericInput("obsc2", "Observed Concentration (mg/L)", 10, min = NA, max = NA, step = NA,
                                                             width = NULL)
                                                ,
           ...
           tabPanel("PK profile 1", tabName="main", icon = icon("line-chart"),
                    column(width=3,
           ...
           tabPanel("PK profile 2", tabName="main2",icon = icon("line-chart"),
                    column(width=3,
